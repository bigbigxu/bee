...
class App
{
    ...
    {
        $className = $this->classAlias($className) ?: $className;
    ...
    public function getComponents()
    {
        $core = [
            ...
            'db' => function () {
                return \bee\core\BeeMysql::getInstance('db.main');
            },
            'redis' => function () {
                return \bee\core\BeeRedis::getInstance('redis.main');
            }
        ];
